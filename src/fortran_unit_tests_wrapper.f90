...
test_exitflag(10) = test_grow_01()
test_exitflag(11) = test_grow_02()
test_exitflag(12) = test_grow_03()
test_exitflag(13) = test_grow_04()
test_exitflag(14) = test_grow_05()
test_exitflag(15) = test_bootstrap_01()
test_exitflag(16) = test_bootstrap_balanced_01()
test_exitflag(17) = test_grow_forest_01()
test_exitflag(18) = test_grow_predict_forest_01()
