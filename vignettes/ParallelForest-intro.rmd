...
Since we did not choose any of the control parameters, let's see what the package chose for them. Notice that this package uses S4 classes, so we need to use `@` instead of `$` to pull out values of the fitted forest object.
